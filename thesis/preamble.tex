...
\lstdefinelanguage{Python}{
	...
	emph={map, filter, reduce, lambda, print, input, open, range, len, int, str, float, list, dict, set, tuple},
	...
	morestring=[b]',
	morestring=[b]",
	ndkeywords={int, str, float, list, dict, set, tuple, bool, bytes, bytearray, memoryview, complex, frozenset},
